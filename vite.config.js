...
export default defineConfig({
  ...
  plugins: [
    VitePWA({
      ...
      manifest: {
        name: 'Clicker Pioneer: AI Settlement',
        short_name: 'ClickerPioneer',
        description: 'A premium clicker strategy RPG built with hand-tracking AI mechanics.',
        theme_color: '#0f172a',
